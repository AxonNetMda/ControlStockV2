<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master" CodeBehind="Empresa_Nuevo.aspx.vb" Inherits="capaAdministracion.Empresa_Nuevo" %>
                               ...
                               <asp:HiddenField runat="server" ID="txtidEmpresa"/>
                                ...
                                <div class="form-group">
                                 ...
                                 <div class="form-group">
                                  ...
                                  <div class="form-group">
                                     <div class="form-floating mb-3">   
                                        <asp:TextBox ID="txtNumeroDocumento" runat="server" TextMode="Number" CssClass="form-control"></asp:TextBox>
                                ...
                                <div class="form-group">
                                     <div class="form-floating mb-3">   
                                        <asp:DropDownList ID="cboEsDemo" runat="server" CssClass="form-control"></asp:DropDownList>
                                        <label for="cboEsDemo">Es Demo:</label>
                                     </div>
                                </div>
                                <div class="form-group">
                                     <div class="form-floating mb-3">   
                                        <asp:TextBox ID="txtFechaInicioDemo" runat="server" TextMode="Date" CssClass="form-control"></asp:TextBox>
                                        <label for="txtFechaInicioDemo">Inicio demo:</label>
                                     </div>
                                </div>  
                                <div class="form-group">
                                     <div class="form-floating mb-3">   
                                        <asp:TextBox ID="txtFechaAlta" runat="server" TextMode="Date" CssClass="form-control"></asp:TextBox>
