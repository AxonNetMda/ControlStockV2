<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="VerificarCorreoRegistracion.aspx.vb" Inherits="capaAdministracion.VerificarCorreoRegistracion" %>
    ...
    <Scripts>
        ...
        <asp:ScriptReference Name="WebFormsBundle" />
            ...
            <div class="container">
                ...
                <a class="navbar-brand" runat="server" href="~/Account/login.aspx">VERIFICACION DE SU CUENTA</a>
        ...
        <asp:Panel runat="server" CssClass="card p-4 shadow" style="width: 100%; max-width: 400px;">
            <!-- Campos de login -->
                ...
                <div class="mb-3">
                    <p>Le enviamos a su correo un link de verificacion para que active su cuenta</p>
                </div>
